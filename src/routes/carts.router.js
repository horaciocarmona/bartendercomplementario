...
routerCart.delete('/:cid/products/:pid', async (req, res) => {
    let respuesta = cartManager.deleteProductsCart(req.params.cid, req.params.pid)
    res.send(respuesta)
})
...
routerCart.put('/:cid/products/:pid', async (req, res) => {
    ...
    const respuesta = await cartManager.addProductCart(req.params.cid, req.params.pid, parseInt(cant))
...
routerCart.get('/:cid', async (req, res) => {
    ...
    if (CartProducts) {
        ...
        res.send(`no existe el carrito con id: ${req.params.cid} en la base de datos`)
    }
})
...
routerCart.post('/:cid', async (req, res) => {
    ...
    if (carrito) {
        ...
        console.log(`no existe el carrito con id: ${req.params.cid} en base de datos`)
